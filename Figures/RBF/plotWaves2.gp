...
set term pdf size 30,8 font "Amiri, 60"
...
p sin(k*x)/(k*x) ls 1 t "Spherical, l=0", \
  real(exp(-sqrt(-1)*x*k)*(2*k*x)**l * F_1(1+l+sqrt(-1)/k, 2*l+2, sqrt(-1)*k*x) ) ls 6 t "real(Coulomb), l=0",\
...
p sin(k*x)/(k*x)**2-cos(k*x)/(k*x) ls 1 t "Spherical, l=1", \
  real(exp(-sqrt(-1)*x*k)*(2*k*x)**l * F_1(1+l+sqrt(-1)/k, 2*l+2, sqrt(-1)*k*x)/factorial(2*l+1) ) ls 6 t "real(Coulomb), l=1",\
  imag(exp(-sqrt(-1)*x*k)*(2*k*x)**l * F_1(1+l+sqrt(-1)/k, 2*l+2, sqrt(-1)*k*x)/factorial(2*l+1) ) ls 3 t "imag(Coulomb), l=1"
...
p sin(k*x)*(3/(k*x)**3-1/(k*x))-3*cos(x*k)/(k*x)**2 ls 1 t "Spherical", \
  real(exp(-sqrt(-1)*x*k)*(2*k*x)**l * F_1(1+l+sqrt(-1)/k, 2*l+2, sqrt(-1)*k*x)/factorial(2*l+1) ) ls 6 t "real(Coulomb)",\
  imag(exp(-sqrt(-1)*x*k)*(2*k*x)**l * F_1(1+l+sqrt(-1)/k, 2*l+2, sqrt(-1)*k*x)/factorial(2*l+1) ) ls 3 t "imag(Coulomb)"

...
However, using such a mapping directly leads to arbitrarily high oscillations in the mapped region and thus to arbitrarily sharp features in the mapped range. % and hence the representation of the FEF would still be poor.
